...
IconData labelGenderIconDataForDisplayValue(String? display) {
...
IconData labelGenderIconForFieldKey(Map<String, String> data, String fieldKey) {
  String? v;
  ...
  return labelGenderIconDataForDisplayValue(v);
}
