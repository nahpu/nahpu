                  ...
                  builder: (BuildContext context, BoxConstraints constraints) {
                    ...
                    return CommonSettingList(
                      sections: [
                        ...
                        Visibility(
                          visible: catalogFmt == CatalogFmt.birds,
                          child: UserDefinedSettingField(
                            typePrefKey: stomachContPrefKey,
                            fmtPrefKey: stomachContFmtPrefKey,
                            typeName: 'Stomach Content',
                          ),
                        ),
                      ],
                    );
