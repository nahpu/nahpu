  ...
  ProjectData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ProjectData(
      ...
      lastAccessed: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}lastAccessed'],
      ),
    );
  }
...
class Personnel extends Table with TableInfo<Personnel, PersonnelData> {
  ...
  static const VerificationMeta _initialMeta = const VerificationMeta(
    'initial',
  );
  ...
  static const VerificationMeta _isRegisterFieldMeta = const VerificationMeta(
    'isRegisterField',
  );
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<PersonnelData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  PersonnelData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return PersonnelData(
      ...
      currentFieldNumber: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}currentFieldNumber'],
      ),
      ...
      photoPath: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}photoPath'],
      ),
      isRegisterField: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}isRegisterField'],
      )!,
    );
  }
...
class PersonnelData extends DataClass implements Insertable<PersonnelData> {
  ...
  factory PersonnelData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class Media extends Table with TableInfo<Media, MediaData> {
  ...
  static const VerificationMeta _additionalExifMeta = const VerificationMeta(
    'additionalExif',
  );
  ...
  MediaData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return MediaData(
      ...
      secondaryId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}secondaryId'],
      ),
      ...
      lenses: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}lenses'],
      ),
      additionalExif: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}additionalExif'],
      ),
      personnelId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}personnelId'],
      ),
...
class MediaData extends DataClass implements Insertable<MediaData> {
  ...
  MediaCompanion toCompanion(bool nullToAbsent) {
    return MediaCompanion(
      ...
      taken: taken == null && nullToAbsent
          ? const Value.absent()
          : Value(taken),
      camera: camera == null && nullToAbsent
          ? const Value.absent()
          : Value(camera),
      lenses: lenses == null && nullToAbsent
          ? const Value.absent()
          : Value(lenses),
  ...
  MediaData copyWith({
    ...
    additionalExif: additionalExif.present
        ? additionalExif.value
        : this.additionalExif,
...
class Site extends Table with TableInfo<Site, SiteData> {
  ...
  static const VerificationMeta _leadStaffIdMeta = const VerificationMeta(
    'leadStaffId',
  );
  ...
  SiteData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return SiteData(
      ...
      leadStaffId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}leadStaffId'],
      ),
  ...
  SiteData copyWithCompanion(SiteCompanion data) {
    return SiteData(
      ...
      projectUuid: data.projectUuid.present
          ? data.projectUuid.value
          : this.projectUuid,
      leadStaffId: data.leadStaffId.present
...
class Coordinate extends Table with TableInfo<Coordinate, CoordinateData> {
  ...
  static const VerificationMeta _decimalLatitudeMeta = const VerificationMeta(
    'decimalLatitude',
  );
  ...
  static const VerificationMeta _decimalLongitudeMeta = const VerificationMeta(
    'decimalLongitude',
  );
  ...
  static const VerificationMeta _gpsUnitMeta = const VerificationMeta(
    'gpsUnit',
  );
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<CoordinateData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  CoordinateData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return CoordinateData(
      ...
      nameId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}nameId'],
      ),
      decimalLatitude: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}decimalLatitude'],
      ),
      ...
      uncertaintyInMeters: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}uncertaintyInMeters'],
      ),
      gpsUnit: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}gpsUnit'],
      ),
      notes: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}notes'],
...
class CoordinateData extends DataClass implements Insertable<CoordinateData> {
  ...
  factory CoordinateData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class CollEvent extends Table with TableInfo<CollEvent, CollEventData> {
  ...
  static const VerificationMeta _idSuffixMeta = const VerificationMeta(
    'idSuffix',
  );
  ...
  static const VerificationMeta _primaryCollMethodMeta = const VerificationMeta(
    'primaryCollMethod',
  );
  ...
  static const VerificationMeta _collMethodNotesMeta = const VerificationMeta(
    'collMethodNotes',
  );
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<CollEventData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  CollEventData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return CollEventData(
      ...
      idSuffix: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}idSuffix'],
      ),
      projectUuid: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}projectUuid'],
      ...
      primaryCollMethod: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}primaryCollMethod'],
      ),
      collMethodNotes: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}collMethodNotes'],
      ),
      siteID: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}siteID'],
...
class CollEventData extends DataClass implements Insertable<CollEventData> {
  ...
  factory CollEventData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return CollEventData(
      ...
      primaryCollMethod: serializer.fromJson<String?>(
        json['primaryCollMethod'],
      ),
...
class Weather extends Table with TableInfo<Weather, WeatherData> {
  ...
  static const VerificationMeta _lowestDayTempCMeta = const VerificationMeta(
    'lowestDayTempC',
  );
  ...
  static const VerificationMeta _highestDayTempCMeta = const VerificationMeta(
    'highestDayTempC',
  );
  ...
  static const VerificationMeta _lowestNightTempCMeta = const VerificationMeta(
    'lowestNightTempC',
  );
  ...
  static const VerificationMeta _highestNightTempCMeta = const VerificationMeta(
    'highestNightTempC',
  );
  ...
  static const VerificationMeta _averageHumidityMeta = const VerificationMeta(
    'averageHumidity',
  );
  ...
  static const VerificationMeta _dewPointTempMeta = const VerificationMeta(
    'dewPointTemp',
  );
  ...
  static const VerificationMeta _sunriseTimeMeta = const VerificationMeta(
    'sunriseTime',
  );
  ...
  static const VerificationMeta _sunsetTimeMeta = const VerificationMeta(
    'sunsetTime',
  );
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('sunsetTime')) {
      context.handle(
        _sunsetTimeMeta,
        sunsetTime.isAcceptableOrUnknown(data['sunsetTime']!, _sunsetTimeMeta),
      );
    }
  ...
  WeatherData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return WeatherData(
      ...
      lowestDayTempC: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}lowestDayTempC'],
      ),
      highestDayTempC: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}highestDayTempC'],
      ),
      lowestNightTempC: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}lowestNightTempC'],
      ),
      highestNightTempC: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}highestNightTempC'],
      ),
      averageHumidity: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}averageHumidity'],
      ),
      dewPointTemp: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}dewPointTemp'],
      ),
      sunriseTime: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}sunriseTime'],
      ),
      sunsetTime: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}sunsetTime'],
      ),
...
class WeatherData extends DataClass implements Insertable<WeatherData> {
  ...
  factory WeatherData.fromJson(
    ...
    return WeatherData(
      ...
      highestNightTempC: serializer.fromJson<double?>(
        json['highestNightTempC'],
      ),
  ...
  WeatherData copyWith({
    ...
    averageHumidity: averageHumidity.present
        ...
        : this.averageHumidity,
    dewPointTemp: dewPointTemp.present ? dewPointTemp.value : this.dewPointTemp,
  ...
  WeatherData copyWithCompanion(WeatherCompanion data) {
    return WeatherData(
      ...
      dewPointTemp: data.dewPointTemp.present
          ...
          : this.dewPointTemp,
      sunriseTime: data.sunriseTime.present
          ? data.sunriseTime.value
          : this.sunriseTime,
      sunsetTime: data.sunsetTime.present
...
class CollPersonnel extends Table
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<CollPersonnelData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class CollPersonnelData extends DataClass
  ...
  factory CollPersonnelData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class CollEffort extends Table with TableInfo<CollEffort, CollEffortData> {
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<CollEffortData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class CollEffortData extends DataClass implements Insertable<CollEffortData> {
  ...
  factory CollEffortData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class Narrative extends Table with TableInfo<Narrative, NarrativeData> {
  ...
  static const VerificationMeta _writerIdMeta = const VerificationMeta(
    'writerId',
  );
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<NarrativeData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  NarrativeData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return NarrativeData(
      ...
      writerId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}writerId'],
      ),
...
class NarrativeData extends DataClass implements Insertable<NarrativeData> {
  ...
  factory NarrativeData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class NarrativeMedia extends Table
  ...
  static const VerificationMeta _narrativeIdMeta = const VerificationMeta(
    'narrativeId',
  );
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<NarrativeMediaData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  NarrativeMediaData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return NarrativeMediaData(
      narrativeId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}narrativeId'],
      )!,
      mediaId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}mediaId'],
...
class NarrativeMediaData extends DataClass
  ...
  factory NarrativeMediaData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  NarrativeMediaData copyWithCompanion(NarrativeMediaCompanion data) {
    return NarrativeMediaData(
      narrativeId: data.narrativeId.present
          ? data.narrativeId.value
          : this.narrativeId,
      mediaId: data.mediaId.present ? data.mediaId.value : this.mediaId,
    );
  }
...
class SiteMedia extends Table with TableInfo<SiteMedia, SiteMediaData> {
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<SiteMediaData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class SiteMediaData extends DataClass implements Insertable<SiteMediaData> {
  ...
  factory SiteMediaData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class Taxonomy extends Table with TableInfo<Taxonomy, TaxonomyData> {
  ...
  static const VerificationMeta _taxonFamilyMeta = const VerificationMeta(
    'taxonFamily',
  );
  ...
  static const VerificationMeta _citesStatusMeta = const VerificationMeta(
    'citesStatus',
  );
  ...
  static const VerificationMeta _redListCategoryMeta = const VerificationMeta(
    'redListCategory',
  );
  ...
  static const VerificationMeta _countryStatusMeta = const VerificationMeta(
    'countryStatus',
  );
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('taxonClass')) {
      context.handle(
        _taxonClassMeta,
        taxonClass.isAcceptableOrUnknown(data['taxonClass']!, _taxonClassMeta),
      );
    }
    ...
    if (data.containsKey('commonName')) {
      context.handle(
        _commonNameMeta,
        commonName.isAcceptableOrUnknown(data['commonName']!, _commonNameMeta),
      );
    }
    if (data.containsKey('notes')) {
      context.handle(
  ...
  TaxonomyData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return TaxonomyData(
      ...
      taxonFamily: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}taxonFamily'],
      ),
      ...
      commonName: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}commonName'],
      ),
      notes: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}notes'],
      ),
      citesStatus: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}citesStatus'],
      ),
      redListCategory: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}redListCategory'],
      ),
      countryStatus: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}countryStatus'],
      ),
      sortingOrder: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}sortingOrder'],
      ),
      mediaId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}mediaId'],
...
class TaxonomyData extends DataClass implements Insertable<TaxonomyData> {
  ...
  TaxonomyData copyWith({
    ...
    redListCategory: redListCategory.present
        ...
        : this.redListCategory,
    countryStatus: countryStatus.present
        ? countryStatus.value
        : this.countryStatus,
    sortingOrder: sortingOrder.present ? sortingOrder.value : this.sortingOrder,
    mediaId: mediaId.present ? mediaId.value : this.mediaId,
  );
  TaxonomyData copyWithCompanion(TaxonomyCompanion data) {
    return TaxonomyData(
      ...
      taxonOrder: data.taxonOrder.present
          ...
          : this.taxonOrder,
      taxonFamily: data.taxonFamily.present
          ? data.taxonFamily.value
          : this.taxonFamily,
      ...
      commonName: data.commonName.present
          ...
          : this.commonName,
      notes: data.notes.present ? data.notes.value : this.notes,
      citesStatus: data.citesStatus.present
          ? data.citesStatus.value
          : this.citesStatus,
...
class Specimen extends Table with TableInfo<Specimen, SpecimenData> {
  ...
  static const VerificationMeta _iDConfidenceMeta = const VerificationMeta(
    'iDConfidence',
  );
  ...
  static const VerificationMeta _iDMethodMeta = const VerificationMeta(
    'iDMethod',
  );
  ...
  static const VerificationMeta _taxonGroupMeta = const VerificationMeta(
    'taxonGroup',
  );
  ...
  static const VerificationMeta _prepDateMeta = const VerificationMeta(
    'prepDate',
  );
  ...
  static const VerificationMeta _isRelativeTimeMeta = const VerificationMeta(
    'isRelativeTime',
  );
  ...
  static const VerificationMeta _coordinateIDMeta = const VerificationMeta(
    'coordinateID',
  );
  ...
  static const VerificationMeta _collEventIDMeta = const VerificationMeta(
    'collEventID',
  );
  ...
  static const VerificationMeta _collPersonnelIDMeta = const VerificationMeta(
    'collPersonnelID',
  );
  ...
  static const VerificationMeta _collMethodIDMeta = const VerificationMeta(
    'collMethodID',
  );
  ...
  static const VerificationMeta _museumIDMeta = const VerificationMeta(
    'museumID',
  );
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<SpecimenData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('taxonGroup')) {
      context.handle(
        _taxonGroupMeta,
        taxonGroup.isAcceptableOrUnknown(data['taxonGroup']!, _taxonGroupMeta),
      );
    }
  ...
  SpecimenData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return SpecimenData(
      ...
      iDConfidence: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}iDConfidence'],
      ),
      iDMethod: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}iDMethod'],
      ),
      taxonGroup: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}taxonGroup'],
      ),
      condition: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}condition'],
      ),
      prepDate: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}prepDate'],
      ),
      prepTime: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}prepTime'],
      ),
      collectionDate: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}collectionDate'],
      ),
      collectionTime: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}collectionTime'],
      ),
      captureDate: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}captureDate'],
      ),
      isRelativeTime: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}isRelativeTime'],
      ),
      captureTime: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}captureTime'],
      ),
      relativeCaptureTime: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}relativeCaptureTime'],
      ),
      trapType: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}trapType'],
      ),
      methodID: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}methodID'],
      ),
      coordinateID: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
      ...
      projectFieldNumber: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}projectFieldNumber'],
      ),
      collEventID: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}collEventID'],
      ),
      isMultipleCollector: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}isMultipleCollector'],
      ),
      collPersonnelID: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}collPersonnelID'],
      ),
      collMethodID: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}collMethodID'],
      ),
      ...
      preparatorID: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}preparatorID'],
      ),
    );
  }
...
class SpecimenData extends DataClass implements Insertable<SpecimenData> {
  ...
  factory SpecimenData.fromJson(
    ...
    return SpecimenData(
      ...
      relativeCaptureTime: serializer.fromJson<String?>(
        json['relativeCaptureTime'],
      ),
      ...
      isMultipleCollector: serializer.fromJson<int?>(
        json['isMultipleCollector'],
      ),
  ...
  SpecimenData copyWith({
    ...
    iDConfidence: iDConfidence.present ? iDConfidence.value : this.iDConfidence,
    ...
    isRelativeTime: isRelativeTime.present
  ...
  SpecimenData copyWithCompanion(SpecimenCompanion data) {
    return SpecimenData(
      ...
      taxonGroup: data.taxonGroup.present
          ? data.taxonGroup.value
          : this.taxonGroup,
      ...
      projectFieldNumber: data.projectFieldNumber.present
          ...
          : this.projectFieldNumber,
      collEventID: data.collEventID.present
          ? data.collEventID.value
          : this.collEventID,
...
class SpecimenMedia extends Table
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<SpecimenMediaData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class SpecimenMediaData extends DataClass
  ...
  factory SpecimenMediaData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class AssociatedData extends Table
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<AssociatedDataData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class AssociatedDataData extends DataClass
  ...
  factory AssociatedDataData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class PersonnelList extends Table
  ...
  static const VerificationMeta _personnelUuidMeta = const VerificationMeta(
    'personnelUuid',
  );
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<PersonnelListData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  PersonnelListData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return PersonnelListData(
      ...
      personnelUuid: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}personnelUuid'],
      ),
    );
  }
...
class PersonnelListData extends DataClass
  ...
  factory PersonnelListData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  PersonnelListData copyWith({
    ...
    projectUuid: projectUuid.present ? projectUuid.value : this.projectUuid,
    personnelUuid: personnelUuid.present
        ? personnelUuid.value
        : this.personnelUuid,
  );
...
class MammalMeasurement extends Table
  ...
  static const VerificationMeta _showBatFieldsMeta = const VerificationMeta(
    'showBatFields',
  );
  ...
  static const VerificationMeta _tailLengthMeta = const VerificationMeta(
    'tailLength',
  );
  ...
  static const VerificationMeta _hindFootLengthMeta = const VerificationMeta(
    'hindFootLength',
  );
  ...
  static const VerificationMeta _earLengthMeta = const VerificationMeta(
    'earLength',
  );
  ...
  static const VerificationMeta _forearmMeta = const VerificationMeta(
    'forearm',
  );
  ...
  static const VerificationMeta _showEchoFieldsMeta = const VerificationMeta(
    'showEchoFields',
  );
  ...
  static const VerificationMeta _echolocationMeta = const VerificationMeta(
    'echolocation',
  );
  ...
  static const VerificationMeta _accuracySpecifyMeta = const VerificationMeta(
    'accuracySpecify',
  );
  ...
  static const VerificationMeta _testisPositionMeta = const VerificationMeta(
    'testisPosition',
  );
  ...
  static const VerificationMeta _testisLengthMeta = const VerificationMeta(
    'testisLength',
  );
  ...
  static const VerificationMeta _testisWidthMeta = const VerificationMeta(
    'testisWidth',
  );
  ...
  static const VerificationMeta _reproductiveStageMeta = const VerificationMeta(
    'reproductiveStage',
  );
  ...
  static const VerificationMeta _mammaeConditionMeta = const VerificationMeta(
    'mammaeCondition',
  );
  ...
  static const VerificationMeta _vaginaOpeningMeta = const VerificationMeta(
    'vaginaOpening',
  );
  ...
  static const VerificationMeta _pubicSymphysisMeta = const VerificationMeta(
    'pubicSymphysis',
  );
  ...
  static const VerificationMeta _embryoLeftCountMeta = const VerificationMeta(
    'embryoLeftCount',
  );
  ...
  static const VerificationMeta _embryoRightCountMeta = const VerificationMeta(
    'embryoRightCount',
  );
  ...
  static const VerificationMeta _embryoCRMeta = const VerificationMeta(
    'embryoCR',
  );
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('tailLength')) {
      context.handle(
        _tailLengthMeta,
        tailLength.isAcceptableOrUnknown(data['tailLength']!, _tailLengthMeta),
      );
    }
    ...
    if (data.containsKey('tibia')) {
      context.handle(
        _tibiaMeta,
        tibia.isAcceptableOrUnknown(data['tibia']!, _tibiaMeta),
      );
    }
  ...
  MammalMeasurementData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return MammalMeasurementData(
      ...
      showBatFields: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}showBatFields'],
      ),
      totalLength: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}totalLength'],
      ),
      tailLength: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}tailLength'],
      ),
      hindFootLength: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}hindFootLength'],
      ),
      earLength: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}earLength'],
      ),
      forearm: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}forearm'],
      ),
      tibia: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}tibia'],
      ),
      showEchoFields: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}showEchoFields'],
      ),
      echolocation: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}echolocation'],
      ),
      frequencyMax: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}frequencyMax'],
      ),
      frequencyMin: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}frequencyMin'],
      ),
      frequencyAtMaxEnergy: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}frequencyAtMaxEnergy'],
      ),
      ...
      accuracySpecify: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}accuracySpecify'],
      ),
      ...
      testisPosition: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}testisPosition'],
      ),
      testisLength: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}testisLength'],
      ),
      testisWidth: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}testisWidth'],
      ),
      epididymisAppearance: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}epididymisAppearance'],
      ),
      reproductiveStage: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}reproductiveStage'],
      ),
      leftPlacentalScars: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}leftPlacentalScars'],
      ),
      rightPlacentalScars: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}rightPlacentalScars'],
      ),
      mammaeCondition: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}mammaeCondition'],
      ),
      ...
      mammaeAxillaryCount: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}mammaeAxillaryCount'],
      ),
      mammaeAbdominalCount: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}mammaeAbdominalCount'],
      ),
      vaginaOpening: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}vaginaOpening'],
      ),
      pubicSymphysis: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}pubicSymphysis'],
      ),
      embryoLeftCount: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}embryoLeftCount'],
      ),
      embryoRightCount: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}embryoRightCount'],
      ),
      embryoCR: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}embryoCR'],
      ),
      remark: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}remark'],
...
class MammalMeasurementData extends DataClass
  ...
  factory MammalMeasurementData.fromJson(
    ...
    return MammalMeasurementData(
      ...
      frequencyAtMaxEnergy: serializer.fromJson<double?>(
        json['frequencyAtMaxEnergy'],
      ),
      ...
      epididymisAppearance: serializer.fromJson<int?>(
        json['epididymisAppearance'],
      ),
      ...
      rightPlacentalScars: serializer.fromJson<int?>(
        json['rightPlacentalScars'],
      ),
      mammaeCondition: serializer.fromJson<int?>(json['mammaeCondition']),
      mammaeInguinalCount: serializer.fromJson<int?>(
        json['mammaeInguinalCount'],
      ),
      mammaeAxillaryCount: serializer.fromJson<int?>(
        json['mammaeAxillaryCount'],
      ),
      mammaeAbdominalCount: serializer.fromJson<int?>(
        json['mammaeAbdominalCount'],
      ),
  ...
  MammalMeasurementData copyWith({
    ...
    hindFootLength: hindFootLength.present
        ? hindFootLength.value
        : this.hindFootLength,
    ...
    showEchoFields: showEchoFields.present
        ? showEchoFields.value
        : this.showEchoFields,
    echolocation: echolocation.present ? echolocation.value : this.echolocation,
    ...
    testisPosition: testisPosition.present
        ...
        : this.testisPosition,
    testisLength: testisLength.present ? testisLength.value : this.testisLength,
    ...
    mammaeAbdominalCount: mammaeAbdominalCount.present
        ...
        : this.mammaeAbdominalCount,
    vaginaOpening: vaginaOpening.present
        ? vaginaOpening.value
        : this.vaginaOpening,
    pubicSymphysis: pubicSymphysis.present
        ? pubicSymphysis.value
        : this.pubicSymphysis,
  ...
  MammalMeasurementData copyWithCompanion(MammalMeasurementCompanion data) {
    return MammalMeasurementData(
      ...
      totalLength: data.totalLength.present
          ...
          : this.totalLength,
      tailLength: data.tailLength.present
          ? data.tailLength.value
          : this.tailLength,
      ...
      testisLength: data.testisLength.present
          ...
          : this.testisLength,
      testisWidth: data.testisWidth.present
          ? data.testisWidth.value
          : this.testisWidth,
...
class MammalMeasurementCompanion
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (frequencyAtMaxEnergy.present) {
      map['frequencyAtMaxEnergy'] = Variable<double>(
        frequencyAtMaxEnergy.value,
      );
    }
    if (duration.present) {
...
class AvianMeasurement extends Table
  ...
  static const VerificationMeta _wingspanMeta = const VerificationMeta(
    'wingspan',
  );
  ...
  static const VerificationMeta _irisColorMeta = const VerificationMeta(
    'irisColor',
  );
  ...
  static const VerificationMeta _irisHexMeta = const VerificationMeta(
    'irisHex',
  );
  ...
  static const VerificationMeta _billColorMeta = const VerificationMeta(
    'billColor',
  );
  ...
  static const VerificationMeta _billHexMeta = const VerificationMeta(
    'billHex',
  );
  ...
  static const VerificationMeta _tarsusColorMeta = const VerificationMeta(
    'tarsusColor',
  );
  ...
  static const VerificationMeta _tarsusHexMeta = const VerificationMeta(
    'tarsusHex',
  );
  ...
  static const VerificationMeta _broodPatchMeta = const VerificationMeta(
    'broodPatch',
  );
  ...
  static const VerificationMeta _skullOssificationMeta = const VerificationMeta(
    'skullOssification',
  );
  ...
  static const VerificationMeta _hasBursaMeta = const VerificationMeta(
    'hasBursa',
  );
  ...
  static const VerificationMeta _bursaWidthMeta = const VerificationMeta(
    'bursaWidth',
  );
  ...
  static const VerificationMeta _bursaLengthMeta = const VerificationMeta(
    'bursaLength',
  );
  ...
  static const VerificationMeta _stomachContentMeta = const VerificationMeta(
    'stomachContent',
  );
  ...
  static const VerificationMeta _stomachContentRemarkMeta =
      const VerificationMeta('stomachContentRemark');
  late final GeneratedColumn<String> stomachContentRemark =
      GeneratedColumn<String>(
        'stomachContentRemark',
        aliasedName,
        true,
        type: DriftSqlType.string,
        requiredDuringInsert: false,
  ...
  static const VerificationMeta _testisRemarkMeta = const VerificationMeta(
    'testisRemark',
  );
  ...
  static const VerificationMeta _ovaryLengthMeta = const VerificationMeta(
    'ovaryLength',
  );
  ...
  static const VerificationMeta _ovaryWidthMeta = const VerificationMeta(
    'ovaryWidth',
  );
  ...
  static const VerificationMeta _oviductWidthMeta = const VerificationMeta(
    'oviductWidth',
  );
  ...
  static const VerificationMeta _ovaryAppearanceMeta = const VerificationMeta(
    'ovaryAppearance',
  );
  ...
  static const VerificationMeta _firstOvaSizeMeta = const VerificationMeta(
    'firstOvaSize',
  );
  ...
  static const VerificationMeta _secondOvaSizeMeta = const VerificationMeta(
    'secondOvaSize',
  );
  ...
  static const VerificationMeta _thirdOvaSizeMeta = const VerificationMeta(
    'thirdOvaSize',
  );
  ...
  static const VerificationMeta _oviductAppearanceMeta = const VerificationMeta(
    'oviductAppearance',
  );
  ...
  static const VerificationMeta _ovaryRemarkMeta = const VerificationMeta(
    'ovaryRemark',
  );
  ...
  static const VerificationMeta _wingIsMoltMeta = const VerificationMeta(
    'wingIsMolt',
  );
  ...
  static const VerificationMeta _wingMoltMeta = const VerificationMeta(
    'wingMolt',
  );
  ...
  static const VerificationMeta _tailIsMoltMeta = const VerificationMeta(
    'tailIsMolt',
  );
  ...
  static const VerificationMeta _tailMoltMeta = const VerificationMeta(
    'tailMolt',
  );
  ...
  static const VerificationMeta _bodyMoltMeta = const VerificationMeta(
    'bodyMolt',
  );
  ...
  static const VerificationMeta _moltRemarkMeta = const VerificationMeta(
    'moltRemark',
  );
  ...
  static const VerificationMeta _specimenRemarkMeta = const VerificationMeta(
    'specimenRemark',
  );
  ...
  static const VerificationMeta _habitatRemarkMeta = const VerificationMeta(
    'habitatRemark',
  );
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('broodPatch')) {
      context.handle(
        _broodPatchMeta,
        broodPatch.isAcceptableOrUnknown(data['broodPatch']!, _broodPatchMeta),
      );
    }
    ...
    if (data.containsKey('bursaWidth')) {
      context.handle(
        _bursaWidthMeta,
        bursaWidth.isAcceptableOrUnknown(data['bursaWidth']!, _bursaWidthMeta),
      );
    }
    ...
    if (data.containsKey('stomachContentRemark')) {
      context.handle(
        _stomachContentRemarkMeta,
        stomachContentRemark.isAcceptableOrUnknown(
          data['stomachContentRemark']!,
          _stomachContentRemarkMeta,
        ),
      );
    }
    ...
    if (data.containsKey('ovaryWidth')) {
      context.handle(
        _ovaryWidthMeta,
        ovaryWidth.isAcceptableOrUnknown(data['ovaryWidth']!, _ovaryWidthMeta),
      );
    }
    ...
    if (data.containsKey('wingIsMolt')) {
      context.handle(
        _wingIsMoltMeta,
        wingIsMolt.isAcceptableOrUnknown(data['wingIsMolt']!, _wingIsMoltMeta),
      );
    }
    ...
    if (data.containsKey('tailIsMolt')) {
      context.handle(
        _tailIsMoltMeta,
        tailIsMolt.isAcceptableOrUnknown(data['tailIsMolt']!, _tailIsMoltMeta),
      );
    }
    ...
    if (data.containsKey('moltRemark')) {
      context.handle(
        _moltRemarkMeta,
        moltRemark.isAcceptableOrUnknown(data['moltRemark']!, _moltRemarkMeta),
      );
    }
  ...
  AvianMeasurementData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return AvianMeasurementData(
      ...
      irisColor: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}irisColor'],
      ),
      irisHex: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}irisHex'],
      ),
      billColor: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}billColor'],
      ),
      billHex: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
      ...
      tarsusColor: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}tarsusColor'],
      ),
      tarsusHex: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}tarsusHex'],
      ),
      sex: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}sex'],
      ...
      skullOssification: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}skullOssification'],
      ),
      hasBursa: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}hasBursa'],
      ),
      bursaWidth: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}bursaWidth'],
      ),
      bursaLength: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}bursaLength'],
      ),
      fat: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}fat'],
      ),
      stomachContent: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}stomachContent'],
      ),
      stomachContentRemark: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}stomachContentRemark'],
      ),
      testisLength: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}testisLength'],
      ...
      testisRemark: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}testisRemark'],
      ),
      ovaryLength: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}ovaryLength'],
      ),
      ovaryWidth: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}ovaryWidth'],
      ),
      oviductWidth: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}oviductWidth'],
      ),
      ovaryAppearance: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}ovaryAppearance'],
      ),
      firstOvaSize: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}firstOvaSize'],
      ),
      secondOvaSize: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}secondOvaSize'],
      ),
      thirdOvaSize: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}thirdOvaSize'],
      ),
      oviductAppearance: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}oviductAppearance'],
      ),
      ovaryRemark: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}ovaryRemark'],
      ),
      wingIsMolt: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}wingIsMolt'],
      ),
      wingMolt: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}wingMolt'],
      ),
      tailIsMolt: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}tailIsMolt'],
      ),
      tailMolt: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}tailMolt'],
      ),
      bodyMolt: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}bodyMolt'],
      ),
      moltRemark: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}moltRemark'],
      ),
      specimenRemark: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}specimenRemark'],
      ),
      habitatRemark: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}habitatRemark'],
      ),
    );
  }
...
class AvianMeasurementData extends DataClass
  ...
  final String? stomachContentRemark;
  final double? testisLength;
  final double? testisWidth;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || stomachContentRemark != null) {
      map['stomachContentRemark'] = Variable<String>(stomachContentRemark);
    }
    if (!nullToAbsent || testisLength != null) {
      map['testisLength'] = Variable<double>(testisLength);
    }
  ...
  AvianMeasurementCompanion toCompanion(bool nullToAbsent) {
    return AvianMeasurementCompanion(
      ...
      stomachContentRemark: stomachContentRemark == null && nullToAbsent
          ? const Value.absent()
          : Value(stomachContentRemark),
      testisLength: testisLength == null && nullToAbsent
          ? const Value.absent()
          : Value(testisLength),
      testisWidth: testisWidth == null && nullToAbsent
  ...
  factory AvianMeasurementData.fromJson(
    ...
    return AvianMeasurementData(
      ...
      stomachContentRemark: serializer.fromJson<String?>(
        json['stomachContentRemark'],
      ),
      testisLength: serializer.fromJson<double?>(json['testisLength']),
      testisWidth: serializer.fromJson<double?>(json['testisWidth']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'stomachContentRemark': serializer.toJson<String?>(stomachContentRemark),
      'testisLength': serializer.toJson<double?>(testisLength),
      'testisWidth': serializer.toJson<double?>(testisWidth),
  ...
  AvianMeasurementData copyWith({
    ...
    Value<String?> stomachContentRemark = const Value.absent(),
    Value<double?> testisLength = const Value.absent(),
    Value<double?> testisWidth = const Value.absent(),
    ...
    stomachContent: stomachContent.present
        ? stomachContent.value
        : this.stomachContent,
    stomachContentRemark: stomachContentRemark.present
        ? stomachContentRemark.value
        : this.stomachContentRemark,
    testisLength: testisLength.present ? testisLength.value : this.testisLength,
    testisWidth: testisWidth.present ? testisWidth.value : this.testisWidth,
    testisRemark: testisRemark.present ? testisRemark.value : this.testisRemark,
    ...
    oviductWidth: oviductWidth.present ? oviductWidth.value : this.oviductWidth,
    ovaryAppearance: ovaryAppearance.present
        ? ovaryAppearance.value
        : this.ovaryAppearance,
    firstOvaSize: firstOvaSize.present ? firstOvaSize.value : this.firstOvaSize,
    secondOvaSize: secondOvaSize.present
        ? secondOvaSize.value
        : this.secondOvaSize,
    thirdOvaSize: thirdOvaSize.present ? thirdOvaSize.value : this.thirdOvaSize,
    ...
    specimenRemark: specimenRemark.present
        ? specimenRemark.value
        : this.specimenRemark,
    habitatRemark: habitatRemark.present
        ? habitatRemark.value
        : this.habitatRemark,
  );
  AvianMeasurementData copyWithCompanion(AvianMeasurementCompanion data) {
    return AvianMeasurementData(
      ...
      bursaWidth: data.bursaWidth.present
          ? data.bursaWidth.value
          : this.bursaWidth,
      bursaLength: data.bursaLength.present
          ? data.bursaLength.value
          : this.bursaLength,
      fat: data.fat.present ? data.fat.value : this.fat,
      stomachContent: data.stomachContent.present
          ? data.stomachContent.value
          : this.stomachContent,
      stomachContentRemark: data.stomachContentRemark.present
          ? data.stomachContentRemark.value
          : this.stomachContentRemark,
      testisLength: data.testisLength.present
          ? data.testisLength.value
          : this.testisLength,
      ...
      testisRemark: data.testisRemark.present
          ...
          : this.testisRemark,
      ovaryLength: data.ovaryLength.present
          ? data.ovaryLength.value
          : this.ovaryLength,
      ovaryWidth: data.ovaryWidth.present
          ? data.ovaryWidth.value
          : this.ovaryWidth,
      ...
      oviductAppearance: data.oviductAppearance.present
          ...
          : this.oviductAppearance,
      ovaryRemark: data.ovaryRemark.present
          ? data.ovaryRemark.value
          : this.ovaryRemark,
      wingIsMolt: data.wingIsMolt.present
          ? data.wingIsMolt.value
          : this.wingIsMolt,
      wingMolt: data.wingMolt.present ? data.wingMolt.value : this.wingMolt,
      tailIsMolt: data.tailIsMolt.present
          ? data.tailIsMolt.value
          : this.tailIsMolt,
      ...
      moltRemark: data.moltRemark.present
          ? data.moltRemark.value
          : this.moltRemark,
  ...
  String toString() {
    return (StringBuffer('AvianMeasurementData(')
          ...
          ..write('stomachContentRemark: $stomachContentRemark, ')
          ..write('testisLength: $testisLength, ')
          ..write('testisWidth: $testisWidth, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is AvianMeasurementData &&
          ...
          other.stomachContentRemark == this.stomachContentRemark &&
          other.testisLength == this.testisLength &&
          other.testisWidth == this.testisWidth &&
...
class AvianMeasurementCompanion extends UpdateCompanion<AvianMeasurementData> {
  ...
  final Value<String?> stomachContentRemark;
  final Value<double?> testisLength;
  final Value<double?> testisWidth;
  ...
  const AvianMeasurementCompanion({
    ...
    this.stomachContentRemark = const Value.absent(),
    this.testisLength = const Value.absent(),
    this.testisWidth = const Value.absent(),
  ...
  static Insertable<AvianMeasurementData> custom({
    ...
    Expression<String>? stomachContentRemark,
    Expression<double>? testisLength,
    Expression<double>? testisWidth,
    ...
    return RawValuesInsertable({
      ...
      if (stomachContentRemark != null)
        'stomachContentRemark': stomachContentRemark,
      if (testisLength != null) 'testisLength': testisLength,
      if (testisWidth != null) 'testisWidth': testisWidth,
  ...
  AvianMeasurementCompanion copyWith({
    ...
    Value<String?>? stomachContentRemark,
    Value<double?>? testisLength,
    Value<double?>? testisWidth,
    ...
    return AvianMeasurementCompanion(
      ...
      stomachContentRemark: stomachContentRemark ?? this.stomachContentRemark,
      testisLength: testisLength ?? this.testisLength,
      testisWidth: testisWidth ?? this.testisWidth,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (stomachContentRemark.present) {
      map['stomachContentRemark'] = Variable<String>(
        stomachContentRemark.value,
      );
    }
    if (testisLength.present) {
...
class HerpMeasurement extends Table
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('svl')) {
      context.handle(
        _svlMeta,
        svl.isAcceptableOrUnknown(data['svl']!, _svlMeta),
      );
    }
    if (data.containsKey('remark')) {
      context.handle(
...
class SpecimenPart extends Table
  ...
  static const VerificationMeta _tissueIDMeta = const VerificationMeta(
    'tissueID',
  );
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<SpecimenPartData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('pmi')) {
      context.handle(
        _pmiMeta,
        pmi.isAcceptableOrUnknown(data['pmi']!, _pmiMeta),
      );
    }
  ...
  SpecimenPartData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return SpecimenPartData(
      ...
      tissueID: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}tissueID'],
      ),
      barcodeID: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}barcodeID'],
      ),
      type: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}type'],
      ...
      timeTaken: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}timeTaken'],
      ),
      pmi: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}pmi'],
      ),
...
class SpecimenPartData extends DataClass
  ...
  factory SpecimenPartData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
typedef $ProjectProcessedTableManager =
...
typedef $PersonnelUpdateCompanionBuilder =
    PersonnelCompanion Function({
      Value<String> uuid,
      Value<String?> name,
      Value<String?> initial,
...
typedef $PersonnelProcessedTableManager =
    ProcessedTableManager<
      _$Database,
      Personnel,
      PersonnelData,
                ...
                return [
                  if (narrativeRefs)
                    await $_getPrefetchedData<MediaData, Media, NarrativeData>(
                      currentTable: table,
                      referencedTable: $MediaReferences._narrativeRefsTable(db),
                      managerFromTypedResult: (p0) =>
                          $MediaReferences(db, table, p0).narrativeRefs,
                      referencedItemsForCurrentItem: (item, referencedItems) =>
                          referencedItems.where(
                            (e) => e.mediaID == item.primaryId,
                          ),
                      typedResults: items,
                    ),
                ];
...
typedef $MediaProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool narrativeRefs})
    >;
typedef $SiteCreateCompanionBuilder =
...
final class $SiteReferences extends BaseReferences<_$Database, Site, SiteData> {
  ...
  _collEventRefsTable(_$Database db) => MultiTypedResultKey.fromTable(
    db.collEvent,
    aliasName: 'site__id__collEvent__siteID',
  );

  $CollEventProcessedTableManager get collEventRefs {
    final manager = $CollEventTableManager(
      $_db,
      $_db.collEvent,
                ...
                return [
                  if (collEventRefs)
                    await $_getPrefetchedData<SiteData, Site, CollEventData>(
                      currentTable: table,
                      referencedTable: $SiteReferences._collEventRefsTable(db),
                      managerFromTypedResult: (p0) =>
...
typedef $SiteProcessedTableManager =
    ProcessedTableManager<
      _$Database,
      Site,
      SiteData,
...
typedef $CoordinateUpdateCompanionBuilder =
    CoordinateCompanion Function({
      Value<int?> id,
      Value<String?> nameId,
      Value<double?> decimalLatitude,
...
typedef $CoordinateProcessedTableManager =
    ProcessedTableManager<
      _$Database,
      Coordinate,
      CoordinateData,
      ...
      PrefetchHooks Function()
    >;
typedef $CollEventCreateCompanionBuilder =
    CollEventCompanion Function({
      Value<int> id,
      Value<String?> idSuffix,
      Value<String?> projectUuid,
      Value<String?> startDate,
...
typedef $CollEventUpdateCompanionBuilder =
    CollEventCompanion Function({
      Value<int> id,
      Value<String?> idSuffix,
      Value<String?> projectUuid,
...
final class $CollEventReferences
  ...
  $SiteProcessedTableManager? get siteID {
    ...
    final manager = $SiteTableManager(
      $_db,
      $_db.site,
                    ...
                    if (siteID) {
                      state =
                          state.withJoin(
                                ...
                                referencedTable: $CollEventReferences
                                    ._siteIDTable(db),
                                referencedColumn: $CollEventReferences
                                    ._siteIDTable(db)
                                    .id,
                              )
                              as T;
...
typedef $CollEventProcessedTableManager =
    ProcessedTableManager<
      _$Database,
      CollEvent,
      CollEventData,
...
typedef $CollPersonnelCreateCompanionBuilder =
    CollPersonnelCompanion Function({
      Value<int> id,
      Value<int?> eventID,
      Value<String?> personnelId,
      Value<String?> name,
...
typedef $CollPersonnelUpdateCompanionBuilder =
    CollPersonnelCompanion Function({
      Value<int> id,
      Value<int?> eventID,
      Value<String?> personnelId,
...
class $CollPersonnelTableManager
    extends
        RootTableManager<
          _$Database,
          CollPersonnel,
...
typedef $CollPersonnelProcessedTableManager =
    ProcessedTableManager<
      _$Database,
      CollPersonnel,
      CollPersonnelData,
      ...
      PrefetchHooks Function()
    >;
typedef $CollEffortCreateCompanionBuilder =
    CollEffortCompanion Function({
      Value<int> id,
      Value<int?> eventID,
      Value<String?> method,
      Value<String?> brand,
...
typedef $CollEffortUpdateCompanionBuilder =
    CollEffortCompanion Function({
      Value<int> id,
      Value<int?> eventID,
      Value<String?> method,
...
typedef $CollEffortProcessedTableManager =
    ProcessedTableManager<
      _$Database,
      CollEffort,
      CollEffortData,
      ...
      PrefetchHooks Function()
    >;
typedef $NarrativeCreateCompanionBuilder =
    NarrativeCompanion Function({
      Value<int> id,
      Value<String?> projectUuid,
      Value<String?> date,
      Value<String?> time,
...
typedef $NarrativeUpdateCompanionBuilder =
    NarrativeCompanion Function({
      Value<int> id,
      Value<String?> projectUuid,
      Value<String?> date,
...
final class $NarrativeReferences
  ...
  $MediaProcessedTableManager? get mediaID {
    ...
    if ($_column == null) return null;
    final manager = $MediaTableManager(
      $_db,
      $_db.media,
                    ...
                    if (mediaID) {
                      state =
                          state.withJoin(
                                ...
                                referencedTable: $NarrativeReferences
                                    ._mediaIDTable(db),
                                referencedColumn: $NarrativeReferences
                                    ._mediaIDTable(db)
                                    .primaryId,
                              )
                              as T;
...
typedef $NarrativeProcessedTableManager =
    ProcessedTableManager<
      _$Database,
      Narrative,
      NarrativeData,
      ...
      PrefetchHooks Function({bool mediaID})
    >;
typedef $NarrativeMediaCreateCompanionBuilder =
    NarrativeMediaCompanion Function({
      required int narrativeId,
      Value<int?> mediaId,
      Value<int> rowid,
    });
typedef $NarrativeMediaUpdateCompanionBuilder =
    NarrativeMediaCompanion Function({
      Value<int> narrativeId,
      Value<int?> mediaId,
      Value<int> rowid,
...
class $NarrativeMediaTableManager
    extends
        RootTableManager<
          _$Database,
          NarrativeMedia,
...
typedef $NarrativeMediaProcessedTableManager =
    ProcessedTableManager<
      _$Database,
      NarrativeMedia,
      NarrativeMediaData,
      ...
      PrefetchHooks Function()
    >;
typedef $SiteMediaCreateCompanionBuilder =
    SiteMediaCompanion Function({
      required int siteId,
      Value<int?> mediaId,
      Value<int> rowid,
    });
typedef $SiteMediaUpdateCompanionBuilder =
    SiteMediaCompanion Function({
      Value<int> siteId,
      Value<int?> mediaId,
      Value<int> rowid,
...
typedef $SiteMediaProcessedTableManager =
    ProcessedTableManager<
      _$Database,
      SiteMedia,
      SiteMediaData,
...
typedef $TaxonomyProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $SpecimenCreateCompanionBuilder =
    SpecimenCompanion Function({
      required String uuid,
      Value<String?> projectUuid,
      Value<int?> speciesID,
      Value<int?> iDConfidence,
...
typedef $SpecimenUpdateCompanionBuilder =
    SpecimenCompanion Function({
      Value<String> uuid,
      Value<String?> projectUuid,
      Value<int?> speciesID,
...
typedef $SpecimenProcessedTableManager =
    ProcessedTableManager<
      _$Database,
      Specimen,
      SpecimenData,
...
typedef $SpecimenMediaUpdateCompanionBuilder =
    SpecimenMediaCompanion Function({
      Value<String> specimenUuid,
      Value<int?> mediaId,
      Value<int> rowid,
...
class $SpecimenMediaTableManager
    extends
        RootTableManager<
          _$Database,
          SpecimenMedia,
...
typedef $SpecimenMediaProcessedTableManager =
    ProcessedTableManager<
      _$Database,
      SpecimenMedia,
      SpecimenMediaData,
...
typedef $AssociatedDataProcessedTableManager =
    ProcessedTableManager<
      _$Database,
      AssociatedData,
      AssociatedDataData,
...
typedef $PersonnelListCreateCompanionBuilder =
    PersonnelListCompanion Function({
      Value<String?> projectUuid,
      Value<String?> personnelUuid,
      Value<int> rowid,
    });
typedef $PersonnelListUpdateCompanionBuilder =
    PersonnelListCompanion Function({
      Value<String?> projectUuid,
      Value<String?> personnelUuid,
      Value<int> rowid,
...
class $PersonnelListTableManager
    extends
        RootTableManager<
          _$Database,
          PersonnelList,
...
typedef $PersonnelListProcessedTableManager =
    ProcessedTableManager<
      _$Database,
      PersonnelList,
      PersonnelListData,
...
class $AvianMeasurementFilterComposer
  ...
  ColumnFilters<String> get stomachContentRemark => $composableBuilder(
    column: $table.stomachContentRemark,
    builder: (column) => ColumnFilters(column),
  );
...
class $AvianMeasurementOrderingComposer
  ...
  ColumnOrderings<String> get stomachContentRemark => $composableBuilder(
    column: $table.stomachContentRemark,
    builder: (column) => ColumnOrderings(column),
  );
...
class $AvianMeasurementAnnotationComposer
  ...
  GeneratedColumn<String> get stomachContentRemark => $composableBuilder(
    column: $table.stomachContentRemark,
    builder: (column) => column,
  );
...
typedef $SpecimenPartUpdateCompanionBuilder =
    SpecimenPartCompanion Function({
      Value<int?> id,
      Value<String?> specimenUuid,
      Value<String?> personnelId,
...
class $SpecimenPartTableManager
    extends
        RootTableManager<
          _$Database,
          SpecimenPart,
...
typedef $SpecimenPartProcessedTableManager =
    ProcessedTableManager<
      _$Database,
      SpecimenPart,
      SpecimenPartData,
