...
Selecione **Explore more stats** para gráficos, tabelas, filtros e exportações detalhados. A tela abre em **Summary**; mude para a visualização **Explore** e escolha **Counts** ou **Spatial**.

## Exportando estatísticas

Abra **Explore more stats** e depois mude para a visualização **Explore**. Em **Counts**, escolha uma medida e um agrupamento e mude o painel para **Table**. O botão `Export table` grava as linhas exibidas no momento em CSV, TSV, Excel ou JSON. **Spatial** exporta da mesma forma, uma linha por coordenada de local.
